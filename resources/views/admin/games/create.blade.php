        ...
        <form action="{{ route('admin.games.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="release_date" name="release_date"
                    placeholder="Insert Game's Year" value="{{ old('release_date') }}">
            </div>
            {{-- <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="platform" name="platform" placeholder="Insert Platform Name"
                    value="{{ old('platform') }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="price" name="price" placeholder="Insert Game's price"
                    value="{{ old('price') }}">
            </div>
            <div class="mb-3">
                <label for="discount" class="form-label">Game's discount</label>
                <input type="text" class="form-control" id="discount" name="discount" placeholder="Insert Game's discount"
                    value="{{ old('discount') }}">
            </div>
            <div class="mb-3">
                <label for="score" class="form-label">Game's score</label>
                <input type="text" class="form-control" id="score" name="score" placeholder="Insert Game's score"
                    value="{{ old('score') }}">
            </div>
            <div class="mb-3">
                <label for="review" class="form-label">Game's Review</label>
                <input type="text" class="form-control" id="review" name="review" placeholder="Insert Game's review"
                    value="{{ old('review') }}">
            </div>
            <div class="mb-3">
                <label for="pegi" class="form-label">Game's Pegi</label>
                <input type="text" class="form-control" id="pegi" name="pegi" placeholder="Insert Game's Pegi"
                    value="{{ old('pegi') }}">
            </div>
